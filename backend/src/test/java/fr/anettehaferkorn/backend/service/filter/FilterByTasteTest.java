...
class FilterByTasteTest {
    ...
    void matchByTaste() {
        ...
        List<RecommendationDTO> mockedRecommendations=List.of(
                ...
                new RecommendationDTO("EEEE","dinner","red","Spain","light","dry","abcd",2)
        );
        ...
        List<RecommendationDTO> actual=FilterByTaste.matchByTaste(wineQuery,mockedRecommendations);
    ...
    @Test
    void matchByTaste_noMatch() {

        WineQuery wineQuery=new WineQuery("dinner","red","Italy","strong","dry");
    ...
    void matchByAlcohol_idK() {
        ...
        WineQuery wineQuery=new WineQuery("dinner","red","idK","idK","idK");
