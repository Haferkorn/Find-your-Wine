...
function SignUpPage() {
   ...
   const handleSubmit = (event) => {
      ...
      if (checkPasswords()) {
         ...
         setCredentials({ ...credentials, confirm_password: "" })
      }
   }
   ...
   return (
      <PageLayout>
         <Textarea>
            <h2>
               Welcome at <strong>Find Your Wine</strong>
            </h2>
            <p>
               If you haven't got an account yet. You can create one using the
               form below:
            </p>
         </Textarea>
         <Formarea>
...
const PasswordInput = styled.div`
   ...
   background-color: ${(props) =>
      props.colorValue === "initial"
         ? "#fffcf2"
         : props.colorValue === "correct"
         ? "#607466"
         : "#8b2635"};
`
